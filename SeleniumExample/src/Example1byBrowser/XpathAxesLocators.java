...
public class XpathAxesLocators {
	...
	public static void main(String[] args) {
		...
		WebElement e = driver.findElement(By.xpath("//a[contains(text(),'Apollo Hospitals')]/parent::td/following-sibling::td[2]"));
		try{
			if(e.isDisplayed())
			{
		...
		{
			if(trList.get(i).getText().contains("Apollo Hospitals"))
			{
